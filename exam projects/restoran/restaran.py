    ...
    def price(self, amount, id):
        ...
        for i in sum:
            if i['id'] == id and i['amount'] >= amount:
                ...
                print("Bizad abu miqdorda taom yoq ")
    ...
    def add_product(self, name, amount, id):
        ...
        for i in obj:
            if i['name'] != name:
                ...
                print('bunday nomli taom mavjud')
                break
        if a:
            obj.append(new)
...
class Product:
    ...
    def take_list(self):
        product = File('product.json').read()
        print(Fore.BLUE + '=' * 20 + ' Taomlarimiz ' + Fore. BLUE + '=' * 20)
        for i in product:
...
while True:
    print(Fore.YELLOW + '=' * 10, Fore.LIGHTCYAN_EX + 'RESTARAN ', Fore.YELLOW + '=' * 10)
    print('tanlang>>>')
    text1 = '''    
    1) Login 
    2) Register
    ...
    if check == '1':
        ...
        if user.check_login(password):
            while True:
                ...
                if check2 == '1':
                    info = Product()
                    info.take_list()
                    print(Fore.LIGHTMAGENTA_EX + " Taomlardan tanlang")
        ...
        if user1.check_login(password):
            while True:
                print('tanlang>>')
                text = Fore.YELLOW + """
                 1)  Sotib olingan taomlar
                 2)  yangi taom pishirish
                 3)  taomlar menyusi
                 5)  Chiqish
                >>>>"""
                admin = input(text)
                if admin == '2':
                    ...
                    if amount > 0:
                        ...
                        buy.save_product()
                        print('Taom pishirildi🙂')
                    else:
                        print("ay bla qulim kuydi")
                elif admin == '1':
        ...
        username = input("Enter username : ")
        password = input("Enter password : ")
        add = Fore.LIGHTMAGENTA_EX + ''' Oshpazmisiz (ha/ yoq ) '''
        chk1 = input(add)
        if chk1 == 'yoq':
